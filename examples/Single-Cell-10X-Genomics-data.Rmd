...
The bam file we used could be downloaded from here (https://ucsf.app.box.com/s/vg1bycvsjgyg63gkqsputprq5rxzjl6k).

Use samtools to re-index the bam file in linux based environment
```{shell}
samtools index jurkat_293t_downsampled_n500_full_bam.bam
```
