...
In this analysis, we demonstrate that MitoTrace identifies germline mutations in droplet-based single-cell RNA sequencing data (10X Genomics). The underlying BAM file is available from McGinnis et al. (McGinnis et al. 2019). (https://ucsf.app.box.com/s/vg1bycvsjgyg63gkqsputprq5rxzjl6k)
