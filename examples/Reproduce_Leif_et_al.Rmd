...
```{r}
bams <- list.files("/Users/lukas.simon/OneDrive/Miko/UTHealth/projects/MitoTrace/LeifEtAl/23_leif_bam/", full.names = T)
bams <- bams[-grep("bai", bams)]
```

Run MitoTrace and calculate allele frequencies (this will take ~ 2min).
```{r}
