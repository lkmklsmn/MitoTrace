...
In this analysis we will reproduce results in figures 5H & 5I from (Leif et al) 
...
Read the BAM files, the BAM files can be downloaded from the link (https://drive.google.com/open?id=1XaSzUukQkIj6SoItK0H6GNbsD7COLZCJ).
```{r}
